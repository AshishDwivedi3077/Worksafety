...
def AnalyseFIle():
    ...
    apim_key =resp['ApimKey']# "e8e591d41a0b43bf8f21da161c204ad2"
    model_id = resp['ModelID']#'62a96766-80f6-4c23-867b-af07a527d9da'
    post_url = endpoint + "/formrecognizer/v2.0/custom/models/%s/analyze" % model_id
    filePath = resp['filePath'] #r"C:\Users\ashishkumd2\Desktop\PowerApps\AleSodte_Workspace.pdf"
    # source = urlopen('https://checklistform.blob.core.windows.net/forms/JhonSeldi_Workspace.pdf')
